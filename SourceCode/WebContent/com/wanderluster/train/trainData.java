...
public class trainData {
	...
	/*
	 * To build Dataset for trainning
	 * We extract 1000 articles from 20ng-train-all-terms as negative samples
	 * extract 1000 articles from r8-train-all-terms as positive samples,
	 * and filter out those terms whose length less than 3
	 * 
	 */
	...
	/*
	 * Filter out stop word and use stem algorithm
	 * Compute the number of times each term occurs
	 * and Select the top 2000 terms
	 */
	...
	/*
	 * Use Tf-idf method to calculate the weight of each term
	 * All weights are normalized to 0-1 to make the weight balanced
	 */
	...
	/*
	 * use the same scale parameters with trainning process
	 * to scale the test data's vector
	 */
	...
	/*
	 * Convert an article from plain text to vector 
	 */
	public static String convertToVector(String content, String stopDir,
			String featureDir, String rangeDir) throws IOException {
		StringBuffer result = new StringBuffer();
		BufferedReader reader = new BufferedReader(new FileReader(stopDir));
		BufferedReader br = new BufferedReader(new FileReader(featureDir));
		Hashtable<String, Integer> hs = new Hashtable<String, Integer>();
		Hashtable<String, Double> idf = new Hashtable<String, Double>();
		...
		return scale(result.toString(), rangeDir);
	}

	
	
	/*
	 * Using Java Machine Learning Package to do Naive Bayes Classification
	 * to compare different classification method result
	 */
	...
	/*
	 * Using Java Machine Learning Package to do KNN Classification
	 * to compare different classification method result
	 */
	...
	/*
	 * predict one testdata's class type according to its content
	 */
	public static int predict(String content, String modelDir)
			throws IOException {
		svm_model model;
		...
		while (st.hasMoreTokens()) {
			String tmp = st.nextToken();
			int indice = Integer.valueOf(tmp.substring(0, tmp.indexOf(":")));
			double value = Double.valueOf(tmp.substring(tmp.indexOf(":") + 1));
	...
	/*
	 * predict one set of datasets'class type according to their content
	 */
