...
public class MainSearch  extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		List<DocumentEntity> list=gsr.getResult(this.fieldname,currentNum,500);
		//List<DocumentEntity> list=new ArrayList<DocumentEntity>();
		int recordCount=gsr.getScoreDocs(fieldname, 500).length;
		//int recordCount=1;
		System.out.println("list.size------ ---"+list.size()+"-------------");
		PageNumBean pageBean=null;
		System.out.println("recoreCount------ "+recordCount);
